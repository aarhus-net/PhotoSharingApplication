...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "LocationCheckerService" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select LocationCheckerService.svc or LocationCheckerService.svc.cs at the Solution Explorer and start debugging.
